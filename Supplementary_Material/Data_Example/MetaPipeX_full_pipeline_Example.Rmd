---
title: "MetaPipeX_full_pipeline_Example"
...
This example demonstrates how the *MetaPipeX* framework may be used to analyze and harmonize *multi-lab* data. In this document we demonstrate the use of the *MetaPipeX::full_pipeline* function. It implements all of the standardized functions and provides the full pipeline starting at the level of individual participant data (*IPD*). For a demonstration of the stepwise computations, refer to the MetaPipeX_stepwise_Computations_Example.Rmd [on github](#0).
...
![Figure 2](https://raw.githubusercontent.com/JensFuenderich/MetaPipeX/dc55d4a4a03705561b50907e9a5833457de8ab20/Supplementary_Material/Graphics/Example_Step_1.png)
...
![Figure 3](https://raw.githubusercontent.com/JensFuenderich/MetaPipeX/dc55d4a4a03705561b50907e9a5833457de8ab20/Supplementary_Material/Graphics/Example_Step_2.png)
...
#### Computational Steps 3-6: Full Pipeline

All remaining steps to analyze and document the data (including the documentation of IPD) are executed through the *MetaPipeX::full_pipeline* function.

```{r step 6 & documenting MetaPipeX data}

# define path to folder
folder_path_site_sum <- paste(output_folder_path, "/", sep = "")
...
MetaPipeX::full_pipeline(
  data = IPD_RRR4, 
  output_path = folder_path_site_sum,
  folder_name = "lvl1_to_lvl5",
